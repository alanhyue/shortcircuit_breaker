...
data halts;
set haltsdum;
if EXTCOMPLIANCE_DUM=1 and halt=1 and "28Feb2011"d <= date <= "28Feb2012"d;
run;
...
ID permno evt;
by permno evt;
model rirf=mktrf SMB HML / noprint;
run;
...
select a.*, 
	b.Intercept+a.mktrf*b.mktrf+a.SMB*b.SMB+a.HML*b.HML as Eret,
	a.rirf-(b.Intercept+a.mktrf*b.mktrf+a.SMB*b.SMB+a.HML*b.HML) as AR
